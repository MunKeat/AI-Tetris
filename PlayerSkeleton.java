...
public class PlayerSkeleton {
	...
	private static double[] weightsDefault = normalizeWeight(new double[] 
											...
											{0.0151, 0.6614, 0.0829, 0.0120, 0.1671, 0.0615});
	...
	private static int numberOfGames = 100; //how many games to run for a weight set -- for fitness test or trials (mode 2, 3, 4 or 5)
...
class GeneticMaster {
	...
	public static void main(String[] args) {
		GeneticMaster geneticMaster = new GeneticMaster(1000, 100, 500);//set of weights, no of game, turns
