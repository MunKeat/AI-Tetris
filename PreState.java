public class PreState {
	...
	//constructor
	public PreState(int[][] field, int nextPiece, int rowsCleared,
			int[] top, int turn, int[][][] pBottom, int[][] pHeight, int[] pOrient,
			int[][][] pTop, int[][] pWidth) {
		
		this.field = field;
		this.nextPiece = nextPiece;
		this.cleared = rowsCleared;
		this.top = top;
		this.turn = turn;
		this.pBottom = pBottom;
		this.pHeight = pHeight;
		this.pOrients = pOrient;
		this.pTop = pTop;
		this.pWidth = pWidth;
	}
